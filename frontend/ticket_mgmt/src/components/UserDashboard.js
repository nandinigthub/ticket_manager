...
const UserDashboard = () => {
    ...
    const fetchuser = async () => {
        try {
            const userResponse = await axiosInstance.get('authorize/login/user');
    ...
    useEffect(() => {
      ...
      const [userRole, setUserRole] = useState('user'); // Change this to 'user' for a regular user
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-3xl font-bold text-gray-800 my-6">User Dashboard</h2>
                    ...
                    {tickets.length === 0 ? (
                        ...
                        <ul className="space-y-4">
                            {tickets.map((ticket) => (
                                ...
                                >
                                    <div>
                                        {ticket.username === fetchuser.username && (
